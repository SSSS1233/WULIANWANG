!function (t, e) {
    ...
    return function (t) {
        ...
        function r(t, e, i, r) {
            var o = ((t || "") + "").split("\n").length, a = n(t, e), s = n("鍥�", e), l = o * s, u = new d(0, 0, a, l);
        ...
        function a(t, e, i, r, o) {
            if (!e)return "";
            o = o || {}, r = f(r, "...");
            for (var a = f(o.maxIterations, 2), l = f(o.minChar, 0), u = n("鍥�", i), h = n("a", i), c = f(o.placeholder, ""), d = e = Math.max(0, e - 1), p = 0; l > p && d >= h; p++)d -= h;
            var g = n(r);
            g > d && (r = "", g = 0), d = e - g;
            ...
            m = h.each, y = Math.min, x = Math.max, _ = 12, b = 6, w = l.extend({
                type: "visualMap.continuous", init: function () {
                    ...
                    if (i.option.hoverLink) {
                        ...
                        u[0] < r[0] && (c[0] = -(1 / 0)), u[1] > r[1] && (c[1] = 1 / 0), e && (c[0] === -(1 / 0) ? this._showIndicator(h, c[1], "< ", l) : c[1] === 1 / 0 ? this._showIndicator(h, c[0], "> ", l) : this._showIndicator(h, h, "â‰ˆ ", l));
        ...
        t.exports = function (t) {
            "china" === t.map && t.regions.push(new n("å—æµ·è¯¸å²›", o, r))
        }
    }, function (t, e, i) {
        var n = i(1), r = {
            "å—æµ·è¯¸å²›": [32, 80],
